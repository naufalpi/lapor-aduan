...
<section class="bg-white dark:bg-white">
    <div class="max-w-screen-xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        {{-- Sidebar Riwayat --}}
        <aside class="lg:col-span-1 space-y-6 max-h-[500px] overflow-y-auto pr-1 pl-5">
           
            <h2 class="text-lg font-semibold text-gray-800">Riwayat Aduan</h2>
            <ol class="relative border-s border-gray-200 dark:border-gray-700">                  
                <li class="mb-10 ms-6">            
                    ...
                    <div class="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-xs sm:flex dark:order-gray-200 dark:border-gray-600">
                        <div class="text-sm text-gray-800 dark:text-gray-800">
                                <p><strong>Dibuat</strong></p>
                                <p>4 Mei 2025 pukul 12.12 WIB</p>
                                <p class="mt-2">Aduan dibuat oleh Anonim</p>
                            </div>
                </li>
                <li class="mb-10 ms-6">
                    <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
        ...
        <article class="lg:col-span-3 space-y-6">
            ...
            <div class="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                ...
                <span>Tracking ID: <strong>0405250002</strong></span>
            ...
            {{-- Judul dan Isi --}}
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Relokasi Sentra Gudeg Wijilan</h1>
